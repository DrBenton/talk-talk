...
namespace TalkTalk\CorePlugin\Hooks;
...
$app->get('autoloader')->add('TalkTalk\CorePlugin\Hooks', __DIR__ . '/classes');
...
$app->defineFunction(
    ...
    function (\Symfony\Component\HttpFoundation\Response $response) use ($app, &$html_hooks) {
...
$app->after(
    function (\Symfony\Component\HttpFoundation\Request $request, \Symfony\Component\HttpFoundation\Response $response) use ($app) {
...
$app->vars['view.extensions'][] = 'TalkTalk\CorePlugin\Hooks\Plates\Extension\HtmlHooks';
