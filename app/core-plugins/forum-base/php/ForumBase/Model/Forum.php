 ...
 *
 * @package TalkTalk\CorePlugin\ForumBase\Model
 */
class Forum extends ModelWithMetadata
{
    ...
    protected $hidden = array(
        'provider', 'provider_version', 'provider_data'
    );
    ...
    {
        $forumAsArray = parent::toArray();

        foreach ($this->getChildren() as $forumChild) {
            $forumAsArray['children'][] = $forumChild->toArray();
        }
