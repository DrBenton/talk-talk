...
//  var withAlertsCapabilities = require('app/utils/mixins/ui/with-alerts-capabilities');
  ...
  module.exports = defineComponent(ajaxHistory, withUrlUtils);

  myDebug && logger.debug(module.id, 'Component on the bridge, captain!');

  // History.js can't be "RequireJs-shimmed", because it crashes our app compilation :-/
  // --> we have to require it at runtime...
  var History;
  ...
  function ajaxHistory() {
    ...
    this.initHistory = function() {
      ...
      require(['history'], _.bind(function () {
