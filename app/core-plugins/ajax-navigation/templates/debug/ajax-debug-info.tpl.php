...
<fieldset id="ajax-loadings-debug-info" class="hidden">
    ...
    <ul>
        ...
        <li>
            Last Action loading duration: <b class="current-action-loading-duration"></b>s.
        </li>
        <li>
            Actions loaded from Ajax: <b class="nb-actions-loaded"></b>
        </li>
        <li>
            Average Actions real loading duration: <b class="average-actions-loading-duration"></b>s.
        </li>
        <li>
            Actions loaded instantly from cache: <b class="nb-actions-loaded-from-cache">0</b>
        </li>
        <li>
            Average Actions loading duration with actions loaded from cache: <b class="average-actions-loading-duration-with-cache"></b>s.
        </li>
    </ul>
</fieldset>
